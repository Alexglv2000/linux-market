/**
 * LINUX MARKET - LANDING PAGE
 * Author: Alexis Gabriel Lugo Villeda
 * Description: Premium advertising landing page for the native Linux POS.
...
export default function PublicityLandingPage() {
  ...
  return (
    ...
    <div className="min-h-screen text-foreground overflow-x-hidden relative bg-background">
      ...
      {/* 
          GALLERY SECTION / VISTAZO AL SISTEMA
          Displays real screenshots of the application to show professional quality.
      */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-16">
            <div className="space-y-5 max-w-xs">
              ...
              <div className="pt-4 space-y-1">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20">Autor Principal</p>
                <p className="text-xs font-bold text-violet-400/80 uppercase tracking-widest">Alexis Gabriel Lugo Villeda</p>
              </div>
            </div>
